  ...
  for (i=0; i<=7; i++)
    for (j=0; j<=7; j++)
	    for (k=0; k<=7; k++)
      {
			...
			if ((i==7) && (j==7) && (k == 7))
			{
				jello.p[i][j][k].x=1.0 + 2.0 / 7;
				jello.p[i][j][k].y=1.0 + 2.0 / 7;
				jello.p[i][j][k].z=1.0 + 2.0 / 7;
			}
// 			if (k == 7)
// 			{
// 				jello.p[i][j][k].x=1.0 * i / 7 * 0.9;
// 				jello.p[i][j][k].y=1.0 * j / 7 * 0.9;
// 				jello.p[i][j][k].z=1.0 * k / 7 * 0.9;
// 			}
// 			if (k == 0)
// 			{
// 				jello.p[i][j][k].x=1.0 * i / 7 * 1.1;
// 				jello.p[i][j][k].y=1.0 * j / 7 * 1.1;
// 				jello.p[i][j][k].z=1.0 * k / 7 * 1.1;
// 			}

		}
// 		jello.p[7][7][7].x = 1.0 + 2.0 / 7;
// 		jello.p[7][7][7].y = 1.0 + 2.0 / 7;
// 		jello.p[7][7][7].z = 1.0 + 2.0 / 7;
...
// 			}
  ...
  writeWorld("test_gravity.w",&jello);
